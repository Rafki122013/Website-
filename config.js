...
(function () {
    ...
    video.muted = true;
    video.loop = true;
    video.src = 'https://files.catbox.moe/ghbiao.mp4'; // Background mu
        ...
        container.innerHTML = `
            <div class="relative">
                <video autoplay loop muted playsinline class="profile-img w-32 h-32 rounded-full object-cover border-4 border-white/30 shadow-2xl">
                    <source src="https://files.catbox.moe/ayqcjj.mp4" type="video/mp4">
                    Your browser does not video the video tag.
                </video>
            </div>
        `; // Foto profile mu
    }
